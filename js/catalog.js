...
function addSelectedItemToCart() {
  ...
  //let newproduct = state.allProducts //document.getelementbyid('items')
  let newPQuanity = document.getElementById('quantity').value;
  state.cart.items.push(new CartItem(newProduct, newPQuanity));
}
...
function updateCartPreview() {
 ...
 {
   preview.src = state.allProducts[i].filepath;
 }
 
   updateCartPreview.src = state.allProducts[i]
 }*/
